...
save('observe_x.mat',  'RMSE_Y_XnoY_UVGC', 'RMSE_X_XnoY_UVGC')
...
[RMSE_Y_XnoY_UVBW, RMSE_X_XnoY_UVBW] = L96_EnKF_Multitrial(params, Nt, dtObs, sigma2Y, sigma2X,... 
                                Frac_Obs_Y, Frac_Obs_X, Ne, x_position, rInf, Adapt_Inf, ...
                                loc_fun_name, loc_params, True_Fcast_Err, Ntrial);
save('observe_x.mat', 'RMSE_Y_XnoY_UVBW', 'RMSE_X_XnoY_UVBW', '-append')
...
[RMSE_Y_XnoY_UVA, RMSE_X_XnoY_UVA] = L96_EnKF_Multitrial(params, Nt, dtObs, sigma2Y, sigma2X,... 
                                Frac_Obs_Y, Frac_Obs_X, Ne, x_position, rInf, Adapt_Inf, ...
                                loc_fun_name, loc_params, True_Fcast_Err, Ntrial);
save('observe_x.mat', 'RMSE_Y_XnoY_UVA', 'RMSE_X_XnoY_UVA', '-append')
...
save('observe_x.mat', 'RMSE_Y_XnoY_UVW', 'RMSE_X_XnoY_UVW', '-append')
...
save('observe_x.mat',  'RMSE_Y_XnoY_MVGC', 'RMSE_X_XnoY_MVGC', '-append')
...
[RMSE_Y_XnoY_MVBW, RMSE_X_XnoY_MVBW] = L96_EnKF_Multitrial(params, Nt, dtObs, sigma2Y, sigma2X,... 
                                Frac_Obs_Y, Frac_Obs_X, Ne, x_position, rInf, Adapt_Inf, ...
                                loc_fun_name, loc_params, True_Fcast_Err, Ntrial);
save('observe_x.mat', 'RMSE_Y_XnoY_MVBW', 'RMSE_X_XnoY_MVBW', '-append')
...
save('observe_x.mat',  'RMSE_Y_XnoY_WCGC', 'RMSE_X_XnoY_WCGC', '-append')
...
[RMSE_Y_XnoY_WCBW, RMSE_X_XnoY_WCBW] = L96_EnKF_Multitrial(params, Nt, dtObs, sigma2Y, sigma2X,... 
                                Frac_Obs_Y, Frac_Obs_X, Ne, x_position, rInf, Adapt_Inf, ...
                                loc_fun_name, loc_params, True_Fcast_Err, Ntrial);
save('observe_x.mat', 'RMSE_Y_XnoY_WCBW', 'RMSE_X_XnoY_WCBW', '-append')
