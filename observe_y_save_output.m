...
[RMSE_Y_YnoX_WCBW, RMSE_X_YnoX_WCBW] = L96_EnKF_Multitrial(params, Nt, dtObs, sigma2Y, sigma2X,... 
                                Frac_Obs_Y, Frac_Obs_X, Ne, x_position, rInf, Adapt_Inf, ...
                                loc_fun_name, loc_params, True_Fcast_Err, Ntrial);
save(savefile, 'RMSE_Y_YnoX_WCBW', 'RMSE_X_YnoX_WCBW', '-append')

% 3C. Askey
fprintf('\nAskey\n')
loc_fun_name = 'askey' ; 
loc_params = struct('rYY', rYY, 'rXX', rXX, 'rXY', rYY, 'nu', 1,... 
                    'gammaYY', 0, 'gammaXX', 1, 'gammaXY', 1/6, 'beta', 0); 
[RMSE_Y_YnoX_WCA, RMSE_X_YnoX_WCA] = L96_EnKF_Multitrial(params, Nt, dtObs, sigma2Y, sigma2X,... 
                                Frac_Obs_Y, Frac_Obs_X, Ne, x_position, rInf, Adapt_Inf, ...
                                loc_fun_name, loc_params, True_Fcast_Err, Ntrial);
save(savefile, 'RMSE_Y_YnoX_WCA', 'RMSE_X_YnoX_WCA', '-append')

% 3D. Wendland
fprintf('\nWendland\n')
loc_fun_name = 'wendland' ; 
loc_params = struct('rYY', rYY, 'rXX', rXX, 'rXY', rYY, 'nu', 2,... 
                    'gammaYY', 0, 'gammaXX', 5, 'gammaXY', 5/6, 'k', 1, 'beta', 0);           
